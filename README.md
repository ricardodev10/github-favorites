...
<p align="center">
This is GitFav, an app to bookmark Github profiles.
</p>
...
<p align="center">
<img src=".github/github-favorites.gif">
</p>
...
Use of tables in HTML, apply screen reader only in CSS, classes and inheritance in JavaScript, take care of the application flow with try, catch and throw, immutability, filter method, API, localStorage, destructuring and promises with Async Await.
...
You can view the layout of the project through [THIS LINK](https://www.figma.com/file/ZgS8dm6vGFdb1swCIgkToB/%5BDesafios-Explorer%5D-GitFav-(Copy)-(Copy)?node-id=0%3A1). You need an account on [Figma](https://figma.com) to access it.


## 🚀 Deploy

https://github-favorites-ricardodev10.vercel.app/
...
<img align="left" src="https://www.github.com/ricardodev10.png?size=100">
